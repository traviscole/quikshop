...
// in simulator we redefine to format for QuikShop Developer console
...
{\
	NSString * exceptionName = [@"org.quikshop." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.quikshop";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIQuikShopNativeItemNone = -1, 
	UIQuikShopNativeItemSpinner = -2,
	UIQuikShopNativeItemProgressBar = -3,
	
	UIQuikShopNativeItemSlider = -4,
	UIQuikShopNativeItemSwitch = -5,
	UIQuikShopNativeItemMultiButton = -6,
	UIQuikShopNativeItemSegmented = -7,
	
	UIQuikShopNativeItemTextView = -8,
	UIQuikShopNativeItemTextField = -9,
	UIQuikShopNativeItemSearchBar = -10,
	
	UIQuikShopNativeItemPicker = -11,
	UIQuikShopNativeItemDatePicker = -12,
	
	UIQuikShopNativeItemInfoLight = -13,
	UIQuikShopNativeItemInfoDark = -14,
	
	UIQuikShopNativeItemDisclosure = -15,
	
	UIQuikShopNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all QuikShop instances of
