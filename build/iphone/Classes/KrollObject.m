...
//@interface QuikShopObject : NSObject
//@end

@interface QuikShopObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[QuikShopObject class]])
		{
			for (NSString *key in [[(QuikShopObject*)o modules] allKeys])
			{
